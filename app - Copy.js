...
const baseimgURL="https://my7.digitalexperience.ibm.com/22708d89-7809-4fac-ac93-dfde8000227e";
...
function searchItem(param){
    ...
    var urlForShow = "";
        ...
        //   $("#retriveAlldata").append("<div class='' style='margin: 30px 0 0 10px;'><img src="+ urlForShow +" width=200px height=120px><h3>"+jsonObj.name+"</h3> <p>"+jsonObj.elements.description.value+"</p></div>");
...
$.each(tags, function(t, tag){
    taglist += "<li>"+tag+"</li>";
       ...
       $("#retriveAlldata").append('<div class="ibm-columns">'+
        '<div class="ibm-col-5-2  ibm-center">'+ '<img src=" ' + urlForShow + '" width="250" height="150">'+
         '<a style="position: absolute;" class="ibm-download-link"   href="'+url+'" download></a>'+
        '</div>' +
        "<div class='ibm-col-5-3 ibm-left'>"+
        '<p class="ibm-bold ibm-textcolor-blue-50 ibm-h4">'+jsonObj.name+'</p>' +
        '<p>'+jsonObj.elements.description.value+'</p>'+
      "<ul id='tagsshow'>"+taglist +"</ul>"+
     // "<span class='ibm-ellipsis-link'id='tagclick'></span>"+
        "</div>"+
       
         '</div>');
    
//      '<div class="ibm-col-5-2 ibm-bold ibm-textcolor-blue-50 ibm-left">' +'<p>'+jsonObj.name+'</p>' + '</div>' +
//     //  "<div><ul id='tagsshow'><li>"+val.tags+"</li></ul></div>"+
//   "<div class='ibm-col-5-3 ibm-left'><ul id='tagsshow'>"+taglist +"</ul></div>"+
    //  '<div class="ibm-col-5-2  ibm-center">' +'<p>'+jsonObj.elements.description.value+'</p>' + '</div>' +

     {/*$("#retriveAlldata").append('<div class="ibm-columns">'+
     '<div class="ibm-col-5-2 ibm-background-green-60 ibm-center">' +
               '<img src=" ' + urlForShow + '" width="200" height="120"></div>' +
         '<a style="position: absolute;" class="ibm-download-link"   href="'+url+'" download></a>'+
         '</div>' +
           '<div class="ibm-col-5-2 ibm-background-green-60 ibm-center">' +
              '<p>'+jsonObj.name+'</p>' +
